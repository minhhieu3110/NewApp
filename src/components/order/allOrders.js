...
export default function AllOrders({navigation}) {
  ...
  const navigateToOrderDetails = status => {
    switch (status) {
      case 'Chờ xác nhận':
        return navigation.navigate('OrderDetails', {flag: 1});
      case 'Chờ lấy hàng':
        return navigation.navigate('OrderDetails', {flag: 2});
      case 'Đang giao':
        return navigation.navigate('OrderDetails', {flag: 3});
      case 'Đã giao':
        return navigation.navigate('OrderDetails', {flag: 4});
      case 'Đã hủy':
        return navigation.navigate('OrderDetails', {flag: 5});
    }
  };
  return (
