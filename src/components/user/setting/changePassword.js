    ...
    <View style={style.container}>
      ...
      <View style={{gap: 10, top: 14}}>
        ...
        <View style={style.itemChangePassword}>
          ...
          <TextInput secureTextEntry={true} style={style.textInput} placeholder="Nhập mật khẩu mới" placeholderTextColor={'#808080'}/>
        </View>
        <View style={style.itemChangePassword}>
          <View style={style.titleItem}>
          ...
          <TextInput
            style={style.textInput}
            placeholder="Xác nhận mật khẩu mới"placeholderTextColor={'#808080'}
            secureTextEntry={true}
          />
        </View>
      </View>
